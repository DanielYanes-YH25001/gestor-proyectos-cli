...
Esta es una aplicación de Interfaz de Línea de Comandos (CLI) desarrollada con Python. El objetivo principal del sistema es funcionar como un gestor de proyectos donde se pueden administrar múltiples tareas asignadas a diferentes empleados.
...
Actualmente está 🚧 **en desarrollo**. Para la primera entrega se realiza el análisis de requerimientos y la elaboración de la demo en pseudocódigo.

## Tecnologías a utilizar

- **Lenguaje:** Python 3.x
- **Diseño Lógico:** Pseudocódigo en PSeInt
